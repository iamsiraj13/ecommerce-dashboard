    ...
    <div className="px-2 lg:px-7 py-5">
      <div className="w-full bg-white px-4 py-4 rounded-md h-[calc(100vh-140px)]">
        <div className="flex w-full h-full relative">
          ...
          >
            <div className="w-full h-[calc(100vh-177px)] bg-white md:bg-transparent overflow-y-auto">
              ...
              <div
                className={`h-[60px] flex justify-start gap-2 items-center text-black px-2 py-2 rounded-sm cursor-pointer bg-sky`}
              >
          ...
          <div className="w-full md:w-[calc(100%-200px)] md:pl-4">
            ...
            <div className="py-4">
              <div className="bg-sky h-[calc(100vh-290px)] rounded-md p-3 overflow-y-auto">
