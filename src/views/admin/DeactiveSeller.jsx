    ...
    <div className="px-2 lg:px-7 pt-5">
      <div className="w-full p-4  bg-white shadow-md rounded-md">
        ...
        <div className="relative overflow-x-auto">
          <table className="w-full text-sm text-left text-black mt-2">
            <thead className="text-xs text-black uppercase border-b border-slate-700 bg-sky font-semibold font-inter">
              <tr>
