    ...
    <>
      <div className="px-2 lg:px-7 pt-5">
        <div className="flex lg:hidden justify-between items-center mb-5 p-4 bg-white rounded-md">
          <h1 className="text-black font-semibold text-lg">Categorys</h1>
          <button
            onClick={() => setShow(true)}
            className="bg-indigo-500 shadow-lg hover:shadow-indigo-500/50 px-4 py-2 cursor-pointer text-black rounded-sm text-sm"
          >
            Add
          </button>
        </div>
          ...
          <div className="w-full lg:w-7/12">
            <div className="w-full p-4  bg-white rounded-md">
              <div className="flex justify-between items-center">
                ...
                <input
                  className="px-4 py-2 focus:border-indigo-500 outline-none  bg-skye border border-slate-700 rounded-md text-black"
                  type="text"
                  placeholder="search"
                />
              </div>
