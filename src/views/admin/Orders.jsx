      ...
      <div className="w-full p-4  bg-white rounded-md">
        ...
        <div className="relative mt-5 overflow-x-auto">
          <div className="w-full text-sm text-left [#d0d2d6]">
            <div className="text-sm text-black uppercase border-b border-slate-700">
            ...
            <div className="text-black">
              ...
              <div
                className={
                  show ? "block transition-all duration-700  bg-sky" : "hidden"
                }
              >
            ...
            <div className="text-black">
              ...
              <div
                className={
                  show ? "block border-b border-slate-700 bg-white" : "hidden"
                }
              >
                <div className="flex justify-start items-start border-b border-slate-700">
                  <div className="py-4 w-[25%] font-medium whitespace-nowrap pl-3">
